	...
	*/
	...
	if(instrucao.opcode == "000000"){
		...
		if(instrucao.funct == "100000"){
			...
			Regwrite = 0;
			Alusrc = 0;
			Aluop = 0; // não achei o valor, acho que não importa para o jr.
			MemtoReg = 0;
			Jump = 1;
			Branch = 0;
			Memwrite = 0;
	...
	//Instruções do tipo I
		...
		else if(instrucao.funct == "100011"){ //lw
			Regdst = 0;
			Regwrite = 1;
			Alusrc = 1;
			Aluop = 00;
		...
		else if(instrucao.funct == "101011") { //sw
			Regdst = 0;
			Regwrite = 0;
			Alusrc = 1;
			Aluop = 00;
		...
		else if(instrucao.funct == "000100"){ //beq
			Regdst = 0;
			Regwrite = 0;
			Alusrc = 0;
			Aluop = 01;
		...
		else if(instrucao.funct == "000101"){ //bne
			Regdst = 0;
			Regwrite = 0;
			Alusrc = 0;
			Aluop = 01;
		...
		else if(instrucao.funct == "000101"){ // slt + beq 000000 000100 / Não entendi muito bem essa instrução no anotacoes.txt
			//bge
			Regdst = 0;
			Regwrite = 0;
			Alusrc = 0;
